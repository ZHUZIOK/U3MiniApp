                ...
                <div class="card-actions justify-end">
                    <router-link to="/cardUsageRateDescription">
                        <button class="btn">
                            {{
                                t(
                                    "message.reviewTheUsageRateDescription.rateDescription",
                                )
                            }}
                            <div class="">💡</div>
                        </button>
        ...
        <div class="card card-border bg-base-100 shadow-md">
            <div class="card-body">
                ...
                <div class="card-actions justify-end">
                    ...
                    <a
                        href="https://www.notion.so/AP-Ucard-2050681df44480e79e95ffc462986a6e?source=copy_link"
                    >
                        <button class="btn btn-primary">
                            {{ t("message.GoToCheck") }}
                        </button>
