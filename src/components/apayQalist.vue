        ...
        <div class="card card-border bg-base-100 shadow-md">
            <div class="card-body">
                ...
                <div class="collapse bg-base-100 border border-base-300">
                    ...
                    <div class="collapse-content text-sm">{{ t("message.ApayQAInfo.qnswers1") }}
                    </div>
                </div>
                <div class="collapse bg-base-100 border border-base-300">
                    <input name="my-accordion-1" type="radio" />
                    <div class="collapse-title font-semibold">{{ t("message.ApayQAInfo.questions2") }}</div>
                    <div class="collapse-content text-sm">{{ t("message.ApayQAInfo.qnswers2") }}
                    </div>
                </div>
                <div class="collapse bg-base-100 border border-base-300">
                    <input name="my-accordion-1" type="radio" />
                    <div class="collapse-title font-semibold">{{ t("message.ApayQAInfo.questions3") }}</div>
                    <div class="collapse-content text-sm">{{ t("message.ApayQAInfo.qnswers3") }}
                    </div>
                </div>
                <div class="collapse bg-base-100 border border-base-300">
                    <input name="my-accordion-1" type="radio" />
                    <div class="collapse-title font-semibold">{{ t("message.ApayQAInfo.questions4") }}</div>
                    <div class="collapse-content text-sm">{{ t("message.ApayQAInfo.qnswers4") }}
                    </div>
                </div>
                <div class="collapse bg-base-100 border border-base-300">
                    <input name="my-accordion-1" type="radio" />
                    <div class="collapse-title font-semibold">{{ t("message.ApayQAInfo.questions5") }}</div>
                    <div class="collapse-content text-sm">{{ t("message.ApayQAInfo.qnswers5") }}
                    </div>
                </div>
                <div class="collapse bg-base-100 border border-base-300">
                    <input name="my-accordion-1" type="radio" />
                    <div class="collapse-title font-semibold">{{ t("message.ApayQAInfo.questions6") }}</div>
                    <div class="collapse-content text-sm">{{ t("message.ApayQAInfo.qnswers6") }}
                    </div>
                </div>
            </div>
        </div>
